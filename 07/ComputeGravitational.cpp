    ...
    public:
        MassAndDistance(double _m1,double _m2, double _r)
        {
            if(_m1 <= 0.0 || _m2 <= 0.0 || _r <= 0.0)
                throw std::domain_error("Bad/Incorrect values for mass and distance");
            this->m1 = _m1; 
            this->m2 = _m2;
            this->r = _r;
        }
...
int main(void)
{
    ...
    cout << "Force Between Sun and Earth is " << forceBetweenEarthAndSun << " Newton " << endl;
    cout << "Force Between Sun and Jupiter is " << forceBetweenJupiterAndSun << " Newton " << endl;
